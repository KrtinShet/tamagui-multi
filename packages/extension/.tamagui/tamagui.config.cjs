...
var require_createAnimations = __commonJS({
  "../../node_modules/@tamagui/animations-react-native/dist/cjs/createAnimations.js"(exports, module2) {
    ...
    var AnimatedView = import_react_native15.Animated.View;
    var AnimatedText = import_react_native15.Animated.Text;
    function useAnimatedNumber(initial) {
      const state = (0, import_react46.useRef)(
        null
      );
      if (!state.current) {
        state.current = {
          composite: null,
          val: new import_react_native15.Animated.Value(initial),
      ...
      return {
        ...
        setValue(next, { type, ...config2 } = { type: "spring" }, onFinish) {
          ...
          if (type === "direct") {
            ...
            (_a = state.current.composite) == null ? void 0 : _a.stop();
            const composite = import_react_native15.Animated.spring(val, {
              ...config2,
              toValue: next,
              useNativeDriver: !import_web17.isWeb
            });
            composite.start(handleFinish);
            state.current.composite = composite;
          } else {
            (_b = state.current.composite) == null ? void 0 : _b.stop();
            const composite = import_react_native15.Animated.timing(val, {
              ...config2,
              toValue: next,
              useNativeDriver: !import_web17.isWeb
            });
    ...
    function useAnimatedNumberReaction({
      ...
      const onChange = (0, import_web17.useEvent)((current) => {
    ...
    function createAnimations2(animations2) {
      ...
      return {
        ...
        useAnimations: ({ props, onDidAnimate, style, componentState, presence }) => {
          ...
          const animateStyles = (0, import_react46.useRef)({});
          const animatedTranforms = (0, import_react46.useRef)([]);
          const animationsState = (0, import_react46.useRef)(
            /* @__PURE__ */ new WeakMap()
          );
          const animateOnly = props.animateOnly || [];
          const hasAnimateOnly = !!props.animateOnly;
          const args = [JSON.stringify(style), componentState, isExiting, !!onDidAnimate];
          const isThereNoNativeStyleKeys = (0, import_react46.useMemo)(() => {
            if (import_web17.isWeb)
              return true;
          ...
          const res = (0, import_react46.useMemo)(() => {
            var _a;
            const runners = [];
            const completions = [];
            ...
            function update(key, animated, valIn) {
              ...
              const value = animated || new import_react_native15.Animated.Value(val);
              ...
              if (value) {
                ...
                runners.push(() => {
                  ...
                  function getAnimation() {
                    return import_react_native15.Animated[animationConfig.type || "spring"](value, {
                      toValue: animateToValue,
                      useNativeDriver: !import_web17.isWeb && !isThereNoNativeStyleKeys,
                      ...animationConfig
                    });
                  }
                  __name(getAnimation, "getAnimation");
                  const animation = animationConfig.delay ? import_react_native15.Animated.sequence([
                    import_react_native15.Animated.delay(animationConfig.delay),
                    getAnimation()
                  ]) : getAnimation();
...
var require_createMedia = __commonJS({
  "../../node_modules/@tamagui/react-native-media-driver/dist/cjs/createMedia.js"(exports, module2) {
    ...
    function createMedia2(media) {
      (0, import_web17.setupMatchMedia)(import_matchMedia.matchMedia);
      return media;
    }
...
var require_cjs4 = __commonJS({
  "../../node_modules/@tamagui/use-force-update/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_react46 = require("react");
    var isServerSide2 = process.env.TAMAGUI_TARGET === "web" && typeof window === "undefined";
    var idFn3 = /* @__PURE__ */ __name(() => {
    }, "idFn");
    function useForceUpdate2() {
      return isServerSide2 ? idFn3 : (0, import_react46.useReducer)((x) => Math.random(), 0)[1];
    }
...
var require_useControllableState = __commonJS({
  "../../node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    var import_use_event3 = require_cjs7();
    var import_react46 = require("react");
...
var require_Collapsible = __commonJS({
  "../../node_modules/@tamagui/collapsible/dist/cjs/Collapsible.js"(exports, module2) {
    ...
    var import_jsx_runtime52 = require("react/jsx-runtime");
    var import_animate_presence5 = require_cjs5();
    var import_create_context17 = require_cjs6();
    var import_use_controllable_state16 = require_cjs8();
    var import_web17 = require("@tamagui/core-node");
    var React40 = __toESM2(require("react"));
...
var require_Collection = __commonJS({
  "../../node_modules/@tamagui/collection/dist/cjs/Collection.js"(exports, module2) {
    ...
    var import_jsx_runtime52 = require("react/jsx-runtime");
    var import_compose_refs17 = require_cjs10();
...
var require_getElevation = __commonJS({
  "../../node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size3, extras) => {
      if (!size3)
        return;
      const { tokens: tokens3 } = extras;
      const token = tokens3.size[size3];
    ...
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens: tokens3 }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core54.getVariableValue)(tokens3.size["true"]);
...
var require_cjs12 = __commonJS({
  "../../node_modules/@tamagui/get-token/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown = /* @__PURE__ */ __name((type, current, options = defaultOptions) => {
      ...
      const result = (typeof found === "string" ? tokens3[found] : found) || tokens3["$true"];
      return result;
    }, "stepTokenUpOrDown");
...
var require_cjs13 = __commonJS({
  "../../node_modules/@tamagui/get-button-sized/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_get_token12 = require_cjs12();
    var getButtonSized6 = /* @__PURE__ */ __name((val, { tokens: tokens3, props }) => {
      ...
      const radiusToken = tokens3.radius[val] ?? tokens3.radius["$true"];
      return {
...
var require_SizableStack = __commonJS({
  "../../node_modules/@tamagui/stacks/dist/cjs/SizableStack.js"(exports, module2) {
    ...
    var import_core54 = require("@tamagui/core-node");
    var import_get_button_sized6 = require_cjs13();
...
var require_SizableText = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/SizableText.js"(exports, module2) {
    ...
    var import_get_font_sized4 = require_cjs15();
    var import_web17 = require("@tamagui/core-node");
    var variants3 = {
      unstyled: {
        false: {
...
var require_Accordion = __commonJS({
  "../../node_modules/@tamagui/accordion/dist/cjs/Accordion.js"(exports, module2) {
    ...
    var import_jsx_runtime52 = require("react/jsx-runtime");
    var import_collapsible = require_cjs9();
    var import_collection2 = require_cjs11();
    var import_create_context17 = require_cjs6();
    var import_stacks26 = require_cjs14();
    var import_text7 = require_cjs16();
    var import_use_controllable_state16 = require_cjs8();
    var import_use_direction5 = require_cjs17();
    var import_web17 = require("@tamagui/core-node");
    var React40 = __toESM2(require("react"));
...
var require_composeEventHandlers = __commonJS({
  "../../node_modules/@tamagui/helpers/dist/cjs/composeEventHandlers.js"(exports, module2) {
    ...
    __export2(composeEventHandlers_exports, {
      composeEventHandlers: () => composeEventHandlers14
    });
    module2.exports = __toCommonJS2(composeEventHandlers_exports);
    function composeEventHandlers14(og, next, { checkDefaultPrevented = true } = {}) {
      if (!og || !next) {
        return next || og;
      }
    ...
    __name(composeEventHandlers14, "composeEventHandlers");
  }
});
...
var require_validStyleProps = __commonJS({
  "../../node_modules/@tamagui/helpers/dist/cjs/validStyleProps.js"(exports, module2) {
    ...
    var import_constants13 = require_cjs23();
    ...
    var GroupFrame = (0, import_core54.styled)(import_stacks26.ThemeableStack, {
      ...
      variants: {
        ...
        size: (val, { tokens: tokens3 }) => {
          const borderRadius = tokens3.radius[val] ?? val ?? tokens3.radius["$true"];
          return {
            borderRadius
          };
        }
...
var require_ListItem = __commonJS({
  "../../node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_jsx_runtime52 = require("react/jsx-runtime");
    var import_font_size4 = require_cjs22();
    var import_get_font_sized4 = require_cjs15();
    var import_get_token12 = require_cjs12();
      ...
      size: {
        "...size": (val, { tokens: tokens3 }) => {
          return {
            ...
            paddingVertical: (0, import_get_token12.getSpace)(tokens3.space[val], {
              shift: -4
            })
          };
        }
...
var require_mutateTheme = __commonJS({
  "../../node_modules/@tamagui/theme/dist/cjs/_mutateTheme.js"(exports, module2) {
    ...
    function _mutateTheme(props) {
      ...
      const config2 = (0, import_web17.getConfig)();
    ...
    function updateThemeConfig(themeName, theme) {
      const config2 = (0, import_web17.getConfig)();
      config2.themes[themeName] = theme;
      (0, import_web17.updateConfig)("themes", config2.themes);
    }
...
// ../app/src/Providers/ThemeProvider/tamagui.config.ts
var import_animations_react_native = __toESM(require_cjs2());
var import_react_native_media_driver = __toESM(require_cjs3());
...
function usePresence() {
  ...
  (0, import_react5.useEffect)(() => register(id), [id, register]);
  const safeToRemove = /* @__PURE__ */ __name(() => onExitComplete == null ? void 0 : onExitComplete(id), "safeToRemove");
...
function onlyElements(children) {
  const filtered = [];
  import_react7.Children.forEach(children, (child, index3) => {
    if ((0, import_react7.isValidElement)(child)) {
      if (!child.key && import_react7.Children.count(children) > 1) {
        if (process.env.NODE_ENV === "development") {
          console.warn("No key given to AnimatePresence child, assigning index as key");
        }
        filtered.push(
...
var AnimatePresence = /* @__PURE__ */ __name(({
  ...
  const forceRenderLayoutGroup = (0, import_react7.useContext)(LayoutGroupContext).forceRender;
  if (forceRenderLayoutGroup)
    forceRender = forceRenderLayoutGroup;
  ...
  let childrenToRender = filteredChildren;
  const exiting = /* @__PURE__ */ new Set();
  const presentChildren = (0, import_react7.useRef)(childrenToRender);
  const allChildren = (0, import_react7.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react7.cloneElement)(child)) });
}, "AnimatePresence");
AnimatePresence.displayName = "AnimatePresence";

// ../../node_modules/@tamagui/dialog/dist/esm/Dialog.js
var import_aria_hidden = __toESM(require_cjs19());
...
// ../../node_modules/@tamagui/dialog/dist/esm/Dialog.js
var import_focus_scope = __toESM(require_cjs20());
...
var getSizedElevation = /* @__PURE__ */ __name((val, { theme, tokens: tokens3 }) => {
  let num = 0;
  if (val === true) {
    const val2 = (0, import_core4.getVariableValue)(tokens3.size["true"]);
    if (typeof val2 === "number") {
      num = val2;
    } else {
      num = 10;
...
var import_get_button_sized = __toESM(require_cjs13());
...
var SheetImplementationCustom = (0, import_core12.themeable)(
  (0, import_react19.forwardRef)(/* @__PURE__ */ __name(function SheetImplementationCustom2(props, forwardedRef) {
    ...
    const at = (0, import_react19.useRef)(hiddenSize);
    useAnimatedNumberReaction(
      {
...
var import_get_font_sized = __toESM(require_cjs15());
...
var import_image = __toESM(require_cjs21());
...
var getShapeSize = /* @__PURE__ */ __name((size3, { tokens: tokens3 }) => {
  const width = tokens3.size[size3] ?? size3;
  const height = tokens3.size[size3] ?? size3;
  return {
    width,
    height,
    minWidth: width,
...
var import_font_size = __toESM(require_cjs22());
var import_get_button_sized2 = __toESM(require_cjs13());
...
var ButtonIcon = /* @__PURE__ */ __name((props) => {
  ...
  const { size: size3, color: color2 } = (0, import_react24.useContext)(ButtonContext);
...
function useButton(propsIn, { Text: Text5 = Button2.Text } = { Text: Button2.Text }) {
  ...
  const isNested = (0, import_react24.useContext)(ButtonNestingContext);
...
var import_font_size2 = __toESM(require_cjs22());
var import_get_token = __toESM(require_cjs12());
...
var import_get_button_sized3 = __toESM(require_cjs13());
var import_get_font_sized2 = __toESM(require_cjs15());
...
// ../../node_modules/@tamagui/popover/dist/esm/Popover.js
var import_aria_hidden3 = __toESM(require_cjs19());
...
var import_get_token3 = __toESM(require_cjs12());
...
var import_get_token4 = __toESM(require_cjs12());
...
var import_get_token5 = __toESM(require_cjs12());
...
var import_focus_scope3 = __toESM(require_cjs20());
...
var NativeSelectFrame = (0, import_core35.styled)(ThemeableStack, {
  ...
  variants: {
    size: {
      "...size": (val, extras) => {
        const { tokens: tokens3 } = extras;
        const paddingHorizontal = (0, import_core35.getVariableValue)(tokens3.space[val]);
        return {
          borderRadius: tokens3.radius[val] ?? val,
          minHeight: tokens3.size[val],
...
var import_get_token7 = __toESM(require_cjs12());
...
var import_get_token6 = __toESM(require_cjs12());
...
var SliderHorizontal = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    const [state, setState_] = React30.useState(() => ({ size: 0, offset: 0 }));
    const setState = (0, import_core37.createShallowSetState)(setState_);
...
var getThumbSize = /* @__PURE__ */ __name((val) => {
  const tokens3 = (0, import_core37.getTokens)();
  const size3 = typeof val === "number" ? val : (0, import_get_token7.getSize)(tokens3.size[val], {
    shift: -1
  });
  return {
    width: size3,
...
var import_get_token8 = __toESM(require_cjs12());
...
var import_get_button_sized4 = __toESM(require_cjs13());
...
var import_focusable5 = __toESM(require_cjs27());
var import_font_size3 = __toESM(require_cjs22());
var import_get_token9 = __toESM(require_cjs12());
...
var import_get_token10 = __toESM(require_cjs12());
...
var import_focusable6 = __toESM(require_cjs27());
...
var import_get_button_sized5 = __toESM(require_cjs13());
var import_get_font_sized3 = __toESM(require_cjs15());
var import_get_token11 = __toESM(require_cjs12());
...
function alpha(color2, value) {
  ...
  if (color2.startsWith("#")) {
    const hexValue = color2.substring(1);
    rgbaComponents = [
    ...
    rgbaComponents = color2.substring(4, color2.length - 1).split(",").map((component) => parseInt(component.trim(), 10));
  } else if (color2.startsWith("rgba(")) {
    rgbaComponents = color2.substring(5, color2.length - 1).split(",").map(
      (component, index3) => index3 < 3 ? parseInt(component.trim(), 10) : parseFloat(component.trim())
    );
  } else {
  ...
  } else if (color2.startsWith("rgb(") || color2.startsWith("rgba(")) {
...
// ../app/src/Providers/ThemeProvider/palette.ts
var GREY = {
  100: "#F9FAFB",
  200: "#F4F6F8",
  300: "#DFE3E8",
...
var COMMON = {
  ...
  error: ERROR,
  grey: GREY,
  divider: alpha_default(GREY[500], 0.24),
  action: {
    hover: alpha_default(GREY[500], 0.08),
    selected: alpha_default(GREY[500], 0.16),
    disabled: alpha_default(GREY[500], 0.8),
    disabledBackground: alpha_default(GREY[500], 0.24),
    focus: alpha_default(GREY[500], 0.24),
    hoverOpacity: 0.08,
...
var tokens = (0, import_web16.createTokens)({
  color,
  radius,
  zIndex,
  space,
...
// ../app/src/Providers/ThemeProvider/tokens.ts
var tokens2 = (0, import_core53.createTokens)({
  color: {
    ...
    "primary8": alpha_default(PRIMARY.main, 0.08),
    "primary12": alpha_default(PRIMARY.main, 0.12),
    "primary16": alpha_default(PRIMARY.main, 0.16),
    "primary24": alpha_default(PRIMARY.main, 0.24),
    "primary32": alpha_default(PRIMARY.main, 0.32),
    "primary48": alpha_default(PRIMARY.main, 0.48),
    "secondaryLighter": SECONDARY.lighter,
    "secondaryLight": SECONDARY.light,
    "secondary": SECONDARY.main,
    "secondaryDark": SECONDARY.dark,
    "secondaryDarker": SECONDARY.darker,
    "secondary8": alpha_default(SECONDARY.main, 0.08),
    "secondary12": alpha_default(SECONDARY.main, 0.12),
    "secondary16": alpha_default(SECONDARY.main, 0.16),
    "secondary24": alpha_default(SECONDARY.main, 0.24),
    "secondary32": alpha_default(SECONDARY.main, 0.32),
    "secondary48": alpha_default(SECONDARY.main, 0.48),
    "infoLighter": INFO.lighter,
    "infoLight": INFO.light,
    "info": INFO.main,
    "infoDark": INFO.dark,
    "infoDarker": INFO.darker,
    "info8": alpha_default(INFO.main, 0.08),
    "info12": alpha_default(INFO.main, 0.12),
    "info16": alpha_default(INFO.main, 0.16),
    "info24": alpha_default(INFO.main, 0.24),
    "info32": alpha_default(INFO.main, 0.32),
    "info48": alpha_default(INFO.main, 0.48),
    "successLighter": SUCCESS.lighter,
    "successLight": SUCCESS.light,
    "success": SUCCESS.main,
    "successDark": SUCCESS.dark,
    "successDarker": SUCCESS.darker,
    "success8": alpha_default(SUCCESS.main, 0.08),
    "success12": alpha_default(SUCCESS.main, 0.12),
    "success16": alpha_default(SUCCESS.main, 0.16),
    "success24": alpha_default(SUCCESS.main, 0.24),
    "success32": alpha_default(SUCCESS.main, 0.32),
    "success48": alpha_default(SUCCESS.main, 0.48),
    "warningLighter": WARNING.lighter,
    "warningLight": WARNING.light,
    "warning": WARNING.main,
    "warningDark": WARNING.dark,
    "warningDarker": WARNING.darker,
    "warning8": alpha_default(WARNING.main, 0.08),
    "warning12": alpha_default(WARNING.main, 0.12),
    "warning16": alpha_default(WARNING.main, 0.16),
    "warning24": alpha_default(WARNING.main, 0.24),
    "warning32": alpha_default(WARNING.main, 0.32),
    "warning48": alpha_default(WARNING.main, 0.48),
    "errorLighter": ERROR.lighter,
    "errorLight": ERROR.light,
    "error": ERROR.main,
    "errorDark": ERROR.dark,
    "errorDarker": ERROR.darker,
    "error8": alpha_default(ERROR.main, 0.08),
    "error12": alpha_default(ERROR.main, 0.12),
    "error16": alpha_default(ERROR.main, 0.16),
    "error24": alpha_default(ERROR.main, 0.24),
    "error32": alpha_default(ERROR.main, 0.32),
    "error48": alpha_default(ERROR.main, 0.48),
    "grey100": GREY[100],
    "grey200": GREY[200],
    "grey300": GREY[300],
    "grey400": GREY[400],
...
// ../app/src/Providers/ThemeProvider/themes.ts
var light = (0, import_core53.createTheme)({
  background: tokens2.color.white,
  backgroundFocus: tokens2.color.focus,
  backgroundHover: tokens2.color.hover,
  backgroundPress: tokens2.color.selected,
  backgroundStrong: tokens2.color.grey100,
  backgroundTransparent: tokens2.color.transparent,
  borderColor: tokens2.color.divider,
  borderColorFocus: tokens2.color.grey600,
  borderColorHover: tokens2.color.hover,
  borderColorPress: tokens2.color.selected,
  color: tokens2.color.grey800,
  colorFocus: tokens2.color.grey800,
  colorHover: tokens2.color.grey800,
  colorPress: tokens2.color.grey800,
  colorTransparent: tokens2.color.transparent,
  placeholderColor: tokens2.color.grey500,
  shadowColor: tokens2.color.shadowLight,
  shadowColorFocus: tokens2.color.shadowLight,
  shadowColorHover: tokens2.color.shadowLight,
  shadowColorPress: tokens2.color.shadowLight
});
var dark = (0, import_core53.createTheme)({
  background: tokens2.color.grey900,
  backgroundFocus: tokens2.color.focus,
  backgroundHover: tokens2.color.hover,
  backgroundPress: tokens2.color.selected,
  backgroundStrong: tokens2.color.grey100,
  backgroundTransparent: tokens2.color.transparent,
  borderColor: tokens2.color.divider,
  borderColorFocus: tokens2.color.grey500,
  borderColorHover: tokens2.color.hover,
  borderColorPress: tokens2.color.selected,
  color: tokens2.color.white,
  colorFocus: tokens2.color.grey800,
  colorHover: tokens2.color.grey800,
  colorPress: tokens2.color.grey800,
  colorTransparent: tokens2.color.transparent,
  placeholderColor: tokens2.color.grey600,
  shadowColor: tokens2.color.shadowDark,
  shadowColorFocus: tokens2.color.shadowDark,
  shadowColorHover: tokens2.color.shadowDark,
  shadowColorPress: tokens2.color.shadowDark
});
var allThemes = {
  dark,
  light
...
var bodyFont = (0, import_core53.createFont)({
  family: "PublicSans",
  face: {
